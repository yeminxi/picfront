  ...
  methods: {
    setSiteIcon() {
      ...
      if (this.useDarkMode) {
          ...
          iconLink.href = this.userConfig?.siteIcon || '/logo.webp';
          appleIconLink.href = this.userConfig?.siteIcon || '/logo.webp';
          maskIconLink.href = this.userConfig?.siteIcon || '/logo.webp';
      }
